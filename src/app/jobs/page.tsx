  ...
  return (
    <main className="lg:mx-12">
      <div className="flex gap-16">
        <section className="hidden lg:flex flex-col lg:fixed gap-2">
          <h1 className="pl-6 w-full flex gap-2 uppercase text-base font-medium mt-2 mb-6">
            <Image width={35} height={20} src="/filter.svg" alt="filter" />{" "}
            Filters
          </h1>
          <section className="hidden lg:block px-8 h-auto overflow-y-auto py-8 rounded-lg shadow-md w-full flex-none">
        ...
        <section className="mx-4 lg:mx-0 lg:ml-96 lg:py-16 w-full flex flex-col gap-10">
          {data?.map((job, index) => (
